...
public class SignIn {
	...
	public static boolean isInitViewVisible() {
		...
		return ViewUtils.findView("TextView", "mID",
				DefaultStrings.SignInButtonTextId, 0) != null;
	}

	public static boolean isSignInVisible() {
		ShortcutsTyper.delayTime(1000);
		return ViewUtils.findView("EditText", "mID",
				DefaultStrings.SignInEmailTextViewId, 0) != null
				&& ViewUtils.findView("EditText", "mID",
						DefaultStrings.SignInPasswordTextViewId, 0) != null
				&& ViewUtils.findView("TextView", "mText",
						DefaultStrings.SignInText, 0) != null;
	}
	...
	public static void fillSignIn(String email, String password) {
		...
		Gui.touchAView("EditText", "mID",
				DefaultStrings.SignInPasswordTextViewId);
		Gui.type(password);
		Gui.pressBack();
	}
	...
	public static boolean hasInvalidEmailMessage() {
		...
		return ViewUtils.findView("TextView", "mID", "id/textErrorMessage", 0).text
				.equals("\\nInvalid email");
	}

...
public class SignUp
{
	...
	{
		return ViewUtils.findView("EditText", "mID", "id/userinfo_emailEdit", 0).text;
	}
	
	public static boolean getSex()
	{
		return ViewUtils.findView("RadioButton", "mID", "id/userinfo_maleButton", 0).isChecked;
	}
	
	public static boolean getUnit()
	{
		return ViewUtils.findView("RadioButton", "mID", "id/userinfo_usButton", 0).isChecked;
	}

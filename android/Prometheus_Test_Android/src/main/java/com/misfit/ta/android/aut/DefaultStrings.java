...
public class DefaultStrings {
	public static String SignUpInvalidEmailMessage = "Invalid email";
	...
	public static String ForgotPasswordEmailSentMessage = "Check your email for the password reset link";
	public static String SignUpTutorialGotItButtonId = "id/tutorial_start_button";

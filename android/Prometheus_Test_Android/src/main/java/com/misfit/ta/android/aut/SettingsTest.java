...
public class SettingsTest extends AutomationTest {
	...
	@Test(groups = { "android", "Prometheus", "settings", "Included", "ProfileSettings" })
	...
	@Test(groups = { "android", "Prometheus", "settings", "Included", "ShineSettings" })
	...
	@Test(groups = { "android", "Prometheus", "settings", "Included", "GoalSettings" })
	...
	@Test(groups = { "android", "Prometheus", "settings", "Included", "SleepGoalSettings" })

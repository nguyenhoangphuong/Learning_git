...
test("C137: Old state of News screen", function(target, app) {
      ...
      item.value() == "page 2 of 3" ? UIALogger.logPass("FEEDBACK view selected") : UIALogger.logFail("FEEDBACK view selected");

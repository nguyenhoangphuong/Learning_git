...
////    String[] cmd = {"defaults", "write", "com.apple.iphonesimulator", "SimulateDevice", family};
////    runCmd(cmd);
////
...
//        String[] cmd = {"/usr/local/bin/ios-sim", "launch", appPath, "--family", family, "--stderr", clientLog, "--exit"};
//        runCmd(cmd);
//        ShortcutsTyper.delayTime(2000);
//      } else {
//        String[] cmd =
//            {"/Applications/Xcode.app/Contents/Developer/usr/bin/instruments", "-w", Settings.getDeviceId(), "-t",
//                "/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/Library/Instruments/PlugIns/AutomationInstrument.bundle/Contents/Resources/Automation.tracetemplate", appPath};
//        runCmd(cmd);

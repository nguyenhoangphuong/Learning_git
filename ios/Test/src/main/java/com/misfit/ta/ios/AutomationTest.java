...
//    }
  ...
  public void cleanUpTest(Method method, ITestResult tr) {
    try {
      logger.info(getModelhandler().getStatistics());
      String[] extensions = {"log", "1", "2", "3", "4", "5"};
      Collection<File> logs = FileUtils.listFiles(new File("logs"), extensions, false);
  ...
  public void beforeSuite() {
	  ...
	  try {
		  System.out.println("LOG [AutomationTest.beforeSuite]: -------------   1");
	  ...
	  System.out.println("LOG [AutomationTest.beforeSuite]: -------------   2");

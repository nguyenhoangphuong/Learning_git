...
public class AutomationTestBak extends com.misfit.ta.aut.AutomationTest {

    private static final Logger logger = Util.setupLogger(AutomationTestBak.class);
    ...
    public void cleanUpTest(Method method, ITestResult tr) {
        ...
        // pb.command("/bin/sh",
        // "-c","/usr/libexec/PlistBuddy -c \"Print 'All Samples:LogType'\" instrumentscli0.trace/Run 1/Automation Results.plist | /usr/bin/awk -F '=' '/LogType = /{print $2}'");
        // String results = AppHelper.runProcess(pb);
        //
        // // details.append("Testcase:  " + method.getName() + "\tStatus: " +
        // results + "\n");
    ...
    public void afterSuite() throws FileNotFoundException {
        ...
        // "\n" + "Summary report:\n");
        // Files.write(detailReport, "TOTAL: " + (passCount + failCount +
        // unknownCount));

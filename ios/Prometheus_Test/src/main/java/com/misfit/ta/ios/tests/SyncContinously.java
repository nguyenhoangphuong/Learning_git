...
public class SyncContinously {
    ...
    public void QuietSyncContinously() {
        ...
        for (int i = 0; i < numberOfSync; i++) {
            ...
            instrument.start();
            ShortcutsTyper.delayTime(45000);
...
//            ShortcutsTyper.delayTime(10 * 1000);
    ...
    public void ManualSyncContinously() throws InterruptedException, StopConditionException, IOException {
        ...
        // user info
        String email = "thinh@misfitwearables.com";
        String password = "misfit1";
        String serialNumber = "SH0JZ005DS";
        ...
        File file = writeResult("sync/sync_result_detail.xls", failedSyncCount, successfulSyncCount, syncLogs,
                uiStartTime, uiEndTime, statusPassed);
    ...
    private File writeResult(String filepath, int failedSyncCount, int successfulSyncCount, SyncDebugLog[] syncLogs,
            long[] uiStartTime, long[] uiEndTime, boolean[] statusPassed) {
    ...
    public static void main(String[] args) throws InterruptedException, StopConditionException, IOException {
        ...
        // int numberOfSync = (args.length < 3 ? 50 :
        ...
        SyncContinously test = new SyncContinously();
        test.numberOfSync = 50;
        test.QuickManualSyncContinously();
//        test.ManualSyncContinously();
//        test.QuietSyncContinously();

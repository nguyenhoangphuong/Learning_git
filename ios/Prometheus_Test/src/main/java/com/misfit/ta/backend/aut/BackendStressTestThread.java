...
public class BackendStressTestThread implements Runnable {
    ...
    private int NUMBER_OF_ITEMS_PER_DAY = 1;
    private int NUMBER_OF_DAYS = 4;
    private int userCount = 0;

    Logger logger = Util.setupLogger(BackendStressTestThread.class);

    public BackendStressTestThread(int numberOfDays, int numberOfItemsPerDay, int userCount) {
        this.NUMBER_OF_DAYS = numberOfDays;
        this.NUMBER_OF_ITEMS_PER_DAY = numberOfItemsPerDay;

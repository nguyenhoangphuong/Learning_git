...
public class Debug {
	...
	public static void main(String[] args) throws JSONException, IOException {
		...
		OpenAPI.subscribeNotification(Settings.getParameter("MVPOpenAPIClientID"),
				Settings.getParameter("MVPOpenAPIClientSecret"),
				"http://jenkins.misfitwearables.com:8999",
				OpenAPI.NOTIFICATION_RESOURCE_DEVICE);

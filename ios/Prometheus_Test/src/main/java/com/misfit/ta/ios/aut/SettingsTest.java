...
public class SettingsTest extends AutomationTest {
	...
	public void VerifyNonTroublemakerTryOutFeedback()
	...
	@Test(groups = { "ios", "Prometheus", "MVP3", "settings" })
	public void VerifyTroublemakerFeedback() throws InterruptedException,
	...
	@Test(groups = { "ios", "Prometheus", "MVP3", "settings" })
	public void VerifyOtherButtons() throws InterruptedException,
			StopConditionException {
		AppHelper.cleanCache();
		ShortcutsTyper.delayTime(1000);
	...
	@Test(groups = { "ios", "Prometheus", "MVP3", "settings" })
	public void VerifyLikeButton() throws InterruptedException,
			StopConditionException {
		AppHelper.cleanCache();
		ShortcutsTyper.delayTime(1000);
		AppHelper.launchInstrument(AppHelper.getCurrentUdid(),
	...
	@Test(groups = { "ios", "Prometheus", "MVP3", "settings" })
	public void VerifyWebsiteButton() throws InterruptedException,
			StopConditionException {
		AppHelper.cleanCache();
		ShortcutsTyper.delayTime(1000);
		AppHelper.launchInstrument(AppHelper.getCurrentUdid(),
	...
	@Test(groups = { "ios", "Prometheus", "MVP3", "settings" })
	public void VerifyRateButton() throws InterruptedException,
			StopConditionException {
		AppHelper.cleanCache();
		ShortcutsTyper.delayTime(1000);
		AppHelper.launchInstrument(AppHelper.getCurrentUdid(),

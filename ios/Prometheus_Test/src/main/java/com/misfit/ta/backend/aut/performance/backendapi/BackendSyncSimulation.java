...
public class BackendSyncSimulation {
    ...
    Logger logger = Util.setupLogger(BackendSyncSimulation.class);

    public BackendSyncSimulation() {
    ...
    public void signupOneMillionUsers(boolean randomizedOperations) {
        ...
        ResultLogger rlog = ResultLogger.getLogger("sync_simulation" 
    ...
    public static void main(String[] args) {
        BackendSyncSimulation test = new BackendSyncSimulation();

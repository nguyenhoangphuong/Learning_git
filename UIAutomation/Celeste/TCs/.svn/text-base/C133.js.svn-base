...
test("C133: Old state of Agenda Favorite screen", function(target, app) {
     ...
     app.navigationBar().segmentedControls()[0].buttons()["Agenda list StarButton"].tap();
     ...
     item.value() == 1 ? UIALogger.logPass("Favorite view selected") : UIALogger.logFail("Favorite view selected");
